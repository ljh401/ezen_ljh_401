...
<body>
   ...
   <h1> 1. JS예시 servlet[자바웹클래스]에게 통신</h1>
   <button onclick="예제1()" type="button">예제1</button>
   
   <h1> 2. 한글인코딩 JS예시  servlet[자바웹클래스]에게 통신</h1>
   <button onclick="예제2()" type="button">예제2</button>
   
   <h1> 3. [응답 : JSON타입/한글인코딩 ] JS예시  servlet[자바웹클래스]에게 통신</h1>
   <button onclick="예제3()" type="button">예제3</button>
   
    <h1> 4. [응답 : JSON타입/한글인코딩 ] JS예시  servlet[자바웹클래스]에게 통신</h1>
