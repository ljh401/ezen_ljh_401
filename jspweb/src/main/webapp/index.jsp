	...
	<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel" >
	  ...
	  <div class="carousel-inner">
	    <div class="carousel-item active" data-bs-interval="10000" >
	      <img src="/jspweb/img/번개.png" class="d-block w-100" alt="..."  >
	    </div>
	    <div class="carousel-item" data-bs-interval="10000" >
	      <img src="/jspweb/img/케로로.jpg" class="d-block w-100" alt="...">
	    </div>
	    <div class="carousel-item" data-bs-interval="10000" >
	      <img src="/jspweb/img/테리어몬.png" class="d-block w-100" alt="...">
	    </div>
	    <div class="carousel-item" data-bs-interval="10000" >
	      <img src="/jspweb/img/ezenlogo.png" class="d-block w-100" alt="...">
	    </div>
	  </div>
