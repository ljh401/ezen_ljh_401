...
function findByPno( pno ){
	$.ajax({
		...
		success:jsonObject=>{ console.log(jsonObject);
			...
			document.querySelector('.pcname').innerHTML = `판매자 : ${jsonObject.pcname}`;
			document.querySelector('.pdate').innerHTML = `판매자 : ${jsonObject.pdate}`;
			document.querySelector('.pname').innerHTML = `판매자 : ${jsonObject.pname}`;
			document.querySelector('.pprice').innerHTML = `판매자 : ${jsonObject.pprice.toLocaleString()}원`;
			document.querySelector('.pcontent').innerHTML = `판매자 : ${jsonObject.pcontent}`;
		}
	})
}
