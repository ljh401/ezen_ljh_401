...
// 7. 카트내 버거 부분 취소 함수 [ 실행 조건 : X버튼을 클릭했을때]
...
function cartCancel(){ // 전체 취소 : 모두 취소 : 인수X
	cartList.splice( 0 ); // 배열내 모든 요소 삭제
	cartPrint(); // 2. 카트화면 업데이트
	
}

// 9. 카트내 저장된 버거 주문(등록) 함수 [ 실행 조건 : 주문하기 버튼을 클릭했을때 ]
function productOrder() {
	...
	let order = {
		...
		state : 0					// 주문객체 생성시 주문요청으로 상태 초기로 사용
	}
	// 2. 주문배열에 저장하기
