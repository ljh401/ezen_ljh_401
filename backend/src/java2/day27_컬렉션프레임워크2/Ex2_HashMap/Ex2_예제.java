...
public class Ex2_예제 {
	...
	public static void main(String[] args) {
		...
		/*
		 * Map<Integer , Integer> map2 = new HashMap<>(); map2.put(1111, 85); // key :
		 * "신용권" , value : 85 map2.put(2222, 90); map2.put(1, 80); map2.put(2, 95);
		 * System.out.println("map 상태 : " + map2);
		 */
	}
}
