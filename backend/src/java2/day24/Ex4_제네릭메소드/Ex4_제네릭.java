...
public class Ex4_제네릭 {
	...
	public static void main(String[] args) {
		...
		// 2. 
		Box<String> box2 = boxing("홍길동"); // 타입 파라미터에 값 넣으면 (자동으로)값 타입으로 String 대체
