...
public class Ex1_제한된타입파라미터 {
	...
	public static void main(String[] args) {
		...
		//String result3 = compare("안녕","하세요"); // 오류발생 : Number클래스 자손아니므로 불가능
		
		Integer i = 3; 		// Integer클래스는 Number클래스의 자손
		Double d = 3.0; 	// Double클래스는 Number클래스의 자손
		String s = "aa"; 	// String클래스는 Number클래스의 자손이 아님.
	}// f end
}
