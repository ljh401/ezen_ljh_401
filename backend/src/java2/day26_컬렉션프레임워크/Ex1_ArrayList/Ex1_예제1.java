...
public class Ex1_예제1 {
	...
	public static void main(String[] args) {
		...
		// 2. ArrayList 객체 안에 객체 추가
			...
			// 리스트객체명.add( 인덱스 , 객체 ) : 해당 객체를 리스트 내 인덱스 위치에 추가
		...
		Board board = new Board("제목8", "내용8", "글쓴이8"); 	list.add(board);	// 보드 객체 생성후 리스트객체에 추가
		...
		System.out.println("---------4 isEmpty() : " + list.isEmpty() );
			...
			// 3. .forEach(반복변수명 -> { 실행 코드 }) // 화살표 함수 : java[ 매개변수 -> { 실행코드 } ] , js[ 매개변수 => { 실행코드 } ]
