...
public class Ex1_조건문 { // class s
	...
	public static void main(String[] args) { // main s
		...
		System.out.println("2등급은 A등급 입니다.");
		// 2.
		if (score < 90)
		...
		if (score <= 90) {
			...
			System.out.println("3등급은 A등급 입니다.");
		} else {
		...
		System.out.println((int)(Math.random()*6) + 1); // <= ~ < 7
		...
		// 난수 생성 클래스 : Random 클래스
			...
			// 2. 랜덤 값 호출
				// random.next타입명() : 타입의 허용범위 내 난수 생성
		Random random = new Random();
		...
		if (num == 1) { System.out.println("1나옴");}
		else if ( num == 2) { System.out.println("2나옴");}
		else if ( num == 3) { System.out.println("3나옴");}
		else if ( num == 4) { System.out.println("4나옴");}
		else if ( num == 5) { System.out.println("5나옴");}
		else { System.out.println("6나옴");}
		//-----------------------------------------------------------------------
		// [ p.119 ] 주사위 예제 = switch
		
		switch( num) { // num변수를 연결해서 제어
			case 1 :  System.out.println("1나옴"); break;
			case 2 :  System.out.println("2나옴"); break;
			case 3 :  System.out.println("3나옴"); break;
			case 4 :  System.out.println("4나옴"); break;
			case 5 :  System.out.println("5나옴"); break;
			default :  System.out.println("6나옴");
 ...
 * 
 * 3. if( 조건식 ) { 참일경우 실행문 } else{ 거짓일 경우 실행문 }
 * 
 * 4. if( 조건식1 ) { 참1 일경우 실행문 } 
 * else if( 조건식2 ) { 참2 일경우 실행문 } 
 * else if( 조건식3 ) {참3 일경우 실행문 } 
 * else { 거짓일 경우 실행문 } 
 * [ 다수 조건에 하나의 실행문 처리 ] 
 * 
 * 5. if( 조건식1 ) { 참1 일경우 실행문 } 
 * if( 조건식2 ) { 참2 일경우 실행문 } 
 * if( 조건식3 ) { 참3 일경우 실행문 } 
 * if( 조건식4 ) { 참4 일경우 실행문 } 
 * 
 ...
 * switch = 변수 값에 따른 실행
 *  - 경우의 수 값이 정해져 있는경우 / 범위 x
 *  - break; : switch{} 멈춤 /만약에 해당 case 실행후 멈춤
 * 
 */