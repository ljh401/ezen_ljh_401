   ...
   JS: 객체 지향 언어[ OOP : Object Oriednted Programming]
      ...
      JS 객체 = JSON
         1. JS 메모리
            ...
            2. 상수   = 데이터
            3. 배열   = [ 데이터1 , 데이터2 , 데이터3 ]
                   - 배열 단점 : 서로 다른 정보 유형들을 하나의 배열에 관리 어렵다!!
                         ex) 유재석/강호동/신동엽 3명의 회원(정보:아이디,비밀번호,이름,주소 등) 등록
                              ...
                              3방법 : 객체유형
                              	...
                              	let 회원2 = { 아이디 : 'qwe1' , 비밀번호 : 'qwe2' , 이름 : '황태웅', 주소 : '성남'}
                              	let 회원3 = { 아이디 : 'qwe2' , 비밀번호 : 'qwe3' , 이름 : '이진형', 주소 : '서울'}
            4. 객체 = { }
...
console.log('아이디속성 호출 :' + 객체1.아이디) // 객체1의 특정(아이디) 속성내 데이터 호출
console.log('비밀번호속성 호출 :' + 객체1.비밀번호) // 객체내 속성 알고 있으면 데이터 호출 가능하다.
