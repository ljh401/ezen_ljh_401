...
// 6. 삼항연산자 [조건 ? 참 : 거짓(만약 조건이 true이면 참코드 실행 false이면 거짓코드 실행)]
let 나이 = 38		// '나이' 변수에 38저장했다.
let 연령구간 = 나이<=19 ? '청소년' : '성인'
			//조건(true/false 결과 갖는 연산)
console.log('38의 연령구간 :' + 연령구간 )

		// 예제 [조건1 ? 참1 : 조건2 ? 참2 : 조건3 ? 참3 : 거짓]
let 점수 = 78
let 등급 = 점수 >= 90 ? 'A등급' : 
								점수 >= 80 ? 'B등급' : 점수 >= 70 ? 'C등급' : '탈락';		
			// 조건1 ? '참1'		조건2		? 	'참'		: 조건3	  ?  '참3' : '거짓';
...
let value1 = prompt('정수 입력1 :')
let value2 = prompt('정수 입력2 :')
...
let value3 = prompt('정수를 입력하세요 :')
let value4 = prompt('정수를 입력하세요 :')
let value5 = prompt('정수를 입력하세요 :')
	//변수활용
let max = value3	// 1. max변수에 첫번째 입력값 저장한다.					
